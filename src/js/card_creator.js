let cardsCreator = function (products, place) {
  products.forEach((item) => {
    ...
    cardImage.src = require("./../images/arrivals/" + item.image_url);
    cardImage.srcset = "./../images/arrivals/" + item.image_hd;
    cardBadge.textContent = item.status.toUpperCase();
